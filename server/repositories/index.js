...
function createRepositories(db) {
  ...
  return {
    ...
    purchaseLog, mealHistory, sundayDrafts, llmAudit, llmCache, inventoryLog,
    priceReferences, priceHistory, stateSnapshots, receipts, receiptItems,
    kassalProducts, productResolutions, kassalCache, familyProfile,
    filterUsage, recipeSources, auditLog, hasFTS,
