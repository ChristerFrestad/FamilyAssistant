...
export function RecipeEditor(): JSX.Element {
  ...
  return (
    <section
      aria-labelledby="recipe-editor-heading"
        ...
        <form className="flex flex-col gap-4" onSubmit={(e) => void handleSave(e)} noValidate>
          ...
          {recipe && recipe.active === false ? (
            <Card
              ...
              data-testid="recipe-inactive-banner"
            >
          ...
          {blockedList.length > 0 ? (
            <Card
              ...
              data-testid="recipe-allergy-banner"
            >
          ...
          {savedFlash ? (
            <p
              role="status"
              aria-live="polite"
              className="font-body text-meta text-text-2"
              data-testid="recipe-saved"
            >
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-3">
                <h2 className="font-display text-card text-text-1">
                  {t('recipes:fields.ingredients')}
                </h2>
                {ingredientError ? (
                  <p
                    role="alert"
                    className="font-body text-meta text-rose-deep"
                    data-testid="recipe-ingredients-error"
                  >
                    {ingredientError}
                  </p>
                ) : null}
      ...
      >
        <div className="flex flex-row-reverse items-center justify-start gap-2">
          <Button
            ...
            data-testid={
              conflictCount !== null ? 'recipe-409-deactivate' : 'recipe-deactivate-confirm'
            }
          >
            {t('recipes:actions.deactivate')}
          </Button>
...
function RecipeReadOnly({
  ...
  return (
    <div className="flex flex-col gap-4" data-testid="recipe-readonly">
      ...
      {recipe.notes ? (
        <p className="font-body text-body text-text-1 whitespace-pre-wrap">{recipe.notes}</p>
      ) : null}
